...
\begin{lstlisting}[style=javascript, caption={The router function for the app structure"}]
<Routes>
{!!(user.username) && <>
...
\begin{lstlisting}[style=javascript, caption={The loop that updates the results when they are received so they can be placed in the JSX}]
...
\begin{lstlisting}[style=python, caption={The achievement_getter function.}]
